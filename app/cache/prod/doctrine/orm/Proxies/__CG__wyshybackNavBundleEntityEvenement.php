 ...
 */
class Evenement extends \wyshy\backNavBundle\Entity\Evenement implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'wyshy\\backNavBundle\\Entity\\Evenement' . "\0" . 'idevenement', '' . "\0" . 'wyshy\\backNavBundle\\Entity\\Evenement' . "\0" . 'video', '' . "\0" . 'wyshy\\backNavBundle\\Entity\\Evenement' . "\0" . 'libelle', '' . "\0" . 'wyshy\\backNavBundle\\Entity\\Evenement' . "\0" . 'lieu', '' . "\0" . 'wyshy\\backNavBundle\\Entity\\Evenement' . "\0" . 'datedebut', '' . "\0" . 'wyshy\\backNavBundle\\Entity\\Evenement' . "\0" . 'datefin', '' . "\0" . 'wyshy\\backNavBundle\\Entity\\Evenement' . "\0" . 'datedestruction'];
        }
