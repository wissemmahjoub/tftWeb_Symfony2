 ...
 */
class CompterenduTest extends \wyshy\backNavBundle\Entity\CompterenduTest implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'wyshy\\backNavBundle\\Entity\\CompterenduTest' . "\0" . 'idtestCompterendu', '' . "\0" . 'wyshy\\backNavBundle\\Entity\\CompterenduTest' . "\0" . 'libelle', '' . "\0" . 'wyshy\\backNavBundle\\Entity\\CompterenduTest' . "\0" . 'datecreation', '' . "\0" . 'wyshy\\backNavBundle\\Entity\\CompterenduTest' . "\0" . 'contenu', '' . "\0" . 'wyshy\\backNavBundle\\Entity\\CompterenduTest' . "\0" . 'test'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CompterenduTest $proxy) {
     ...
     * {@inheritDoc}
     */
    public function getIdtestCompterendu()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getIdtestCompterendu();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdtestCompterendu', []);

        return parent::getIdtestCompterendu();
    }
     ...
     * {@inheritDoc}
     */
    public function setIdtestCompterendu($idtestCompterendu)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdtestCompterendu', [$idtestCompterendu]);

        return parent::setIdtestCompterendu($idtestCompterendu);
    }
