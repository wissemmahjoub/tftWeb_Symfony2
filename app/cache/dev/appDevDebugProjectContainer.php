...
class appDevDebugProjectContainer extends Container
{
     ...
     * This method always returns the same instance of the service.
     *
     * @return \wyshy\UserBundle\Security\Core\User\OAuthUserProvider A wyshy\UserBundle\Security\Core\User\OAuthUserProvider instance.
     */
    protected function getApp_Provider_OauthService()
    {
        return $this->services['app.provider.oauth'] = new \wyshy\UserBundle\Security\Core\User\OAuthUserProvider($this->get('fos_user.user_manager'), array('facebook' => 'facebookID', 'google' => 'googleID'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'tft', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\wyshy\\backNavBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\wyshy\\UserBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'wyshy\\backNavBundle\\Entity');
        $c->addDriver($b, 'wyshy\\UserBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('wyshybackNavBundle' => 'wyshy\\backNavBundle\\Entity', 'wyshyUserBundle' => 'wyshy\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_408c13dd53b730cfc3c20eecfbabfef1aba872d3afb812a4ea8297831e4b168e');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('wyshy\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('wyshy\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('wyshy\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('wyshy\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'wyshy\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['hwi_oauth.resource_owner.google'] = new \HWI\Bundle\OAuthBundle\OAuth\ResourceOwner\GoogleResourceOwner($this->get('hwi_oauth.http_client'), $this->get('security.http_utils'), array('client_id' => '818478430406-v68cotptt736b5e3bgqs9lcgkpoubtob.apps.googleusercontent.com', 'client_secret' => 'HE011JskSQsZwzJcTL_tHa4A', 'scope' => 'https://www.googleapis.com/auth/userinfo.email https://www.googleapis.com/auth/userinfo.profile', 'paths' => array('email' => 'email'), 'options' => array()), 'google', $this->get('hwi_oauth.storage.session'));
    }
    ...
    {
        $this->services['hwi_oauth.resource_ownermap.main'] = $instance = new \HWI\Bundle\OAuthBundle\Security\Http\ResourceOwnerMap($this->get('security.http_utils'), array('facebook' => 'facebook', 'google' => 'google'), array('facebook' => '/login/check-facebook', 'google' => '/login/check-google'));
     ...
     * This method always returns the same instance of the service.
     *
     * @return \wyshy\UserBundle\Redirection\AfterLoginRedirection A wyshy\UserBundle\Redirection\AfterLoginRedirection instance.
     */
    protected function getRedirect_After_LoginService()
    {
        return $this->services['redirect.after.login'] = new \wyshy\UserBundle\Redirection\AfterLoginRedirection($this->get('router'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $h = $this->get('redirect.after.login');
        ...
        $n = new \Symfony\Component\HttpFoundation\RequestMatcher('^/affichage');
        ...
        $o->add($n, array(0 => 'ROLE_MEMBRE'), NULL);

        $p = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $d, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($d, '/login'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $p->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());

        $q = new \HWI\Bundle\OAuthBundle\Security\Http\Firewall\OAuthListener($b, $f, $g, $d, 'main', $h, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('failure_path' => '/login', 'login_path' => '/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => '/connect_check', 'use_forward' => false, 'require_previous_session' => true), $a, $c);
        $q->setResourceOwnerMap($this->get('hwi_oauth.resource_ownermap.main'));
        $q->setCheckPaths(array(0 => '/login/check-facebook', 1 => '/login/check-google'));

        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($o, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $this->get('fos_user.user_provider.username_email')), 'main', $a, $c), 2 => $p, 3 => new \Symfony\Component\Security\Http\Firewall\UsernamePasswordFormAuthenticationListener($b, $f, $g, $d, 'main', $h, new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationFailureHandler($e, $d, array('failure_path' => '/', 'login_path' => '/login', 'failure_forward' => false, 'failure_path_parameter' => '_failure_path'), $a), array('check_path' => '/login_check', 'use_forward' => false, 'require_previous_session' => true, 'username_parameter' => '_username', 'password_parameter' => '_password', 'csrf_parameter' => '_csrf_token', 'intention' => 'authenticate', 'post_only' => true), $a, $c, $this->get('form.csrf_provider')), 4 => $q, 5 => new \Symfony\Component\Security\Http\Firewall\AnonymousAuthenticationListener($b, '5737f8d8031d7', $a), 6 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $o, $f)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $d, 'main', new \HWI\Bundle\OAuthBundle\Security\Http\EntryPoint\OAuthEntryPoint($e, $d, '/login', false), NULL, NULL, $a));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('federationdetennistunisie@gmail.com');
        $a->setPassword('yassine1994');
        $a->setAuthMode('login');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\wyshy\\navFrontBundle/Resources/views'), 'wyshynavFront');
        $instance->addPath(($this->targetDirs[3].'\\src\\wyshy\\backNavBundle/Resources/views'), 'wyshybackNav');
        $instance->addPath(($this->targetDirs[3].'\\vendor\\friendsofsymfony\\user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath(($this->targetDirs[3].'\\src\\wyshy\\UserBundle/Resources/views'), 'wyshyUser');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_USER'), 'ROLE_MEMBRE' => array(0 => 'ROLE_MEMBRE'), 'ROLE_MEDECIN' => array(0 => 'ROLE_MEDECIN'), 'ROLE_ARBITRE' => array(0 => 'ROLE_ARBITRE'), 'ROLE_RESPONSABLE' => array(0 => 'ROLE_RESPONSABLE'), 'ROLE_JOUEUR' => array(0 => 'ROLE_JOUEUR'), 'ROLE_SUPER_ADMIN' => array(0 => 'ROLE_ADMIN')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'wyshybackNavBundle' => 'wyshy\\backNavBundle\\wyshybackNavBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'wyshyUserBundle' => 'wyshy\\UserBundle\\wyshyUserBundle',
            ...
            'mailer_host' => NULL,
            'mailer_user' => 'federationdetennistunisie@gmail.com',
            'mailer_password' => 'yassine1994',
            'locale' => 'en',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'federationdetennistunisie@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'yassine1994',
            ...
            'fos_user.model.user.class' => 'wyshy\\UserBundle\\Entity\\User',
            ...
            'buttons.facebook' => array(
                'url' => 'http://www.facebook.com/TFTesprit',
                'locale' => 'fr_FR',
                'send' => false,
                'width' => 300,
                'showFaces' => false,
            ...
            'links.googleplus' => array(
                'network' => 'googleplus',
                'url' => 'https://plus.google.com/u/0/117059753051722952402',
                'theme' => 'default',
            ),
